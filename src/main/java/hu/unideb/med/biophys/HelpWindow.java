...
class HelpWindow extends JFrame {
    ...
    public void createGui() {
        ...
        panel.add(label4, gc);
        JLabel label5 = new JLabel("<html>To register the donor images, press the \"Register\" button. If the checkbox is checked, acceptor<br>image pairs will automatically be resgistered using the same shift. This is important for<br>determining the correction factor for incomplete bleaching of the acceptor.</html>");
        panel.add(label5, gc);
